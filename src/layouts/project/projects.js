...
import { getAllProjectsForUser, getUserFirestoreInformation } from "../../utils/apiUtil";
  ...
  if(projectsData) {
    return (
      <Container>
        ...
        <CreateProject uid={props.userData.user["uid"]} token={props.userData.user.stsTokenManager["accessToken"]} userTeams={userTeams} />
        <br />
